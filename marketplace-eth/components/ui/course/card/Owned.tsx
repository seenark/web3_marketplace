import { IOwnedCourseAndICourse } from '@components/hooks/web3/useOwnedCourses';
import Image from 'next/image'

interface IOwnedCourseCardProps {
  children?: React.ReactNode
  course: IOwnedCourseAndICourse
}
...
const OwnedCourseCard: React.FunctionComponent<IOwnedCourseCardProps> = ({ children, course }) => {
