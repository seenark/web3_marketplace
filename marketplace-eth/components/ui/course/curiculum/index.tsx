...
const Curiculum: React.FunctionComponent<ICuriculumProps> = ({ locked, courseState, isLoading }) => {
console.log("🚀 ~ file: index.tsx ~ line 19 ~ courseState", courseState)
